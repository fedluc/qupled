...
void compute_dynamic_adr_iet_re_part2(double *psi_re_part1, double WW,
				      double *ww, input in);

double adr_iet_re_part2_partial_xwW(double uu, void* pp);

void compute_dynamic_adr_iet_re_part3(double *psi_re_part2, double WW,
				      double ww, double *qq, double *uu,
				      input in);

double adr_iet_re_part3_partial_xwuW(double qq, void* pp);

double adr_iet_re_part3_partial_xwu0(double qq, void* pp);
