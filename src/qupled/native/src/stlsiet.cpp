...
double StlsIetUtil::BridgeFunction::get() const {
...
double StlsIetUtil::BridgeFunction::couplingParameter() const {
...
double StlsIetUtil::BridgeFunction::hnc() const { return 0.0; }

double StlsIetUtil::BridgeFunction::ioi() const {
...
double StlsIetUtil::BridgeFunction::lct() const {
  const double Gamma = couplingParameter();
...
double StlsIetUtil::BridgeFunction::lctIntegrand(const double &r,
