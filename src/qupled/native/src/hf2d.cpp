...
//   // (in().getDegeneracy() == 0.0) ? computeSsfGround2D() :
//   // computeSsfFinite2D();
//   computeSsfFinite2D();
// }
...
// double
// HFUtil::Idr::integrand2D(const double &x, const double &y, const int &l) const {
//   double phi;
//   double y2 = y * y;
//   double x2 = x * x;
//   double x4 = x2 * x2;
...
//   assert(Theta > 0.0);
//   auto func1 = [&](const double &y) -> double { return integrandOut(y); };
//   auto func2 = [&](const double &p) -> double { return integrandIn(p); };
