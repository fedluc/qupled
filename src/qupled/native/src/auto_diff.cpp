...
AutoDiff2 operator+(const AutoDiff2 &dual, const double &scalar) {
  return AutoDiff2(
      dual.val + scalar, dual.dx, dual.dy, dual.dxx, dual.dyy, dual.dxy);
}
...
AutoDiff2 operator*(const AutoDiff2 &dual1, const AutoDiff2 &dual2) {
  return AutoDiff2(
      ...
      dual1.val * dual2.dxy + dual1.dx * dual2.dy + dual1.dy * dual2.dx +
          dual1.dxy * dual2.val);
}

AutoDiff2 operator*(const AutoDiff2 &dual, const double &scalar) {
  return AutoDiff2(dual.val * scalar,
                   dual.dx * scalar,
                   dual.dy * scalar,
                   dual.dxx * scalar,
                   dual.dyy * scalar,
...
AutoDiff2 operator/(const AutoDiff2 &dual1, const AutoDiff2 &dual2) {
  ...
  return AutoDiff2(dual1.val * inv_val,
                   ...
                   (dual1.dxx - 2 * dual1.dx * dual2.dx * inv_val -
                    dual1.val * dual2.dxx * inv_val +
                    2 * dual1.val * dual2.dx * dual2.dx * inv_val2) *
                       inv_val,
                   (dual1.dyy - 2 * dual1.dy * dual2.dy * inv_val -
                    dual1.val * dual2.dyy * inv_val +
                    2 * dual1.val * dual2.dy * dual2.dy * inv_val2) *
                       inv_val,
                   (dual1.dxy - dual1.dx * dual2.dy * inv_val -
                    dual1.dy * dual2.dx * inv_val -
                    dual1.val * dual2.dxy * inv_val +
                    2 * dual1.val * dual2.dx * dual2.dy * inv_val2) *
                       inv_val);
}
