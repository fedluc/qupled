...
TEST(StlsIetApiAndUtilTest, SlfcUtilityReturnsZeroAtXZeroIn3D) {
...
TEST(StlsIetApiAndUtilTest, SlfcUtilityReturnsZeroAtXZeroIn2D) {
  const std::vector<double> wvg{0.0, 0.5, 1.0, 1.5, 2.0};
  const std::vector<double> ssf{0.0, 0.4, 0.8, 1.0, 1.0};
  const std::vector<double> lfc{0.0, 0.1, 0.2, 0.2, 0.2};
  const std::vector<double> bf(wvg.size(), 0.0);
...
TEST(StlsIetApiAndUtilTest, SlfcUtilityReturnsFiniteValueAtNonzeroXIn3D) {
  const std::vector<double> wvg{0.0, 0.5, 1.0, 1.5, 2.0};
  const std::vector<double> ssf{0.0, 0.4, 0.8, 1.0, 1.0};
  const std::vector<double> lfc{0.0, 0.1, 0.2, 0.2, 0.2};
  const std::vector<double> bf(wvg.size(), 0.0);
